...
using Nexora.PMPortal.ProjectsDocumentations.Dto;
...
namespace Nexora.PMPortal.Web.Controllers
{
    ...
    public class ProjectsDocumentationsController : PMPortalControllerBase
    {
        ...
        public IActionResult ReadFromKatibeh(string ProjectCode, string DocumentNumber, string TransmitalNumber)
        {
            ...
            SqlConnection SQLConnection = new SqlConnection(_configuration.GetConnectionString("DocControlSystem"));
        ...
        public async Task<IActionResult> ImportExcel(IFormFile ExcelFile)
        {
            ...
            ProjectsTasksViewModel.ConvertAction ConvertAction = delegate (string Parameter)
            {
                ...
                switch (Parameter)
                {
                    ...
                    case "تأييد شده مشروط":
                        Value = 9;
                        break;
                    case "در حال بررسي ماشين سازي ويژه": // legacy Excel templates still use the old company name
                    case "در حال بررسي PM":
                        Value = 10;
                        break;
            ...
            if (ExcelFile != null)
            {
                ...
                else { return Json("The selected file is not a valid Excel file"); } // If File Wasn't Excel Format , Returns Error Alert
        ...
        public async Task<ActionResult> ExportExcel()
        {
            ...
            var FileName = "Engineering Reports - " + new PersianDateTime(DateTime.Parse(DateTime.Now.ToString())).ToLongDateTimeInt() + ".xlsx";
            var FileNameForReturn = "Engineering Reports - " + new PersianDateTime(DateTime.Parse(DateTime.Now.ToString())).ToShortDateString() + ".xlsx"; //This Format Of File Is Used At The End For Returning The File 
