...
using Nexora.PMPortal.Sessions;
using Nexora.PMPortal.Web.Models.Account;
using Nexora.PMPortal.Web.Views.Shared.Components.TenantChange;
using Abp.Runtime.Validation;

namespace Nexora.PMPortal.Web.Controllers
{
    public class AccountController : PMPortalControllerBase
    {
        ...
        public async Task<ActionResult> PasswordChanged()
        {
            return View();
        }
    }
